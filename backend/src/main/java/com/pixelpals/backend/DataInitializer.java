...
public class DataInitializer {
    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            // 1. Inizializzazione Utenti (Admin e Test) - COMMENTATA
            /*
            if (userRepository.findByUsername("admin").isEmpty()) {
                ...
                System.out.println("Utente Admin iniziale creato.");
            }
            ...
            if (userRepository.findByUsername("testuser").isEmpty()) {
                ...
                System.out.println("Utente di test iniziale creato.");
            }
            */

            // 2. Inizializzazione Piattaforme - COMMENTATA
...
/*
            // 3. Inizializzazione Giochi (20+ giochi)
